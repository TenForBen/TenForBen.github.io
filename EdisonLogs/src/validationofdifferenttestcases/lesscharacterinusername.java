...
public class lesscharacterinusername extends setup {
	
	public void minimun(WebDriver driver, String url) throws InterruptedException {
	...
	public void linkval(WebDriver driver) {
	...
	public void emptypage(WebDriver driver, String url) throws InterruptedException {
		WebElement Login= driver.findElement(By.id("zwei"));
		 Login.click();
		 WebElement enterlogin=driver.findElement(By.id("psycho"));
		 enterlogin.click();
	...
	public  void webelements(WebDriver driver, String url) {
		 WebElement Login= driver.findElement(By.id("zwei"));
		 Login.click();
		 List <WebElement> anchor= driver.findElements(By.tagName("a"));
			int a= anchor.size();
	...
	public  void nouservalue(WebDriver driver) throws InterruptedException 
{
