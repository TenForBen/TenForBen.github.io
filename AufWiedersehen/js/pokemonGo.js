...
/*
var vardy=x.pokemon.length;// length of the pokemon list
var Pname=prompt("Enter the name of a pokemon");


for(i=0;i<vardy;i++)
{
	if(x.pokemon[i].name==Pname)
	{
		 alert(x.pokemon[i].name);
		alert(x.pokemon[i].weight);
		alert(x.pokemon[i].height);
		
	}
} */

//var list=pokeDex.pokemon;
//var Nxtname=prompt("Enter the name of a pokemon");
// Function  taking pokemon’s name as argument and displaying the  information of that pokemon.
//var list=x.pokemon;
/*
function displayInfo(name)
 {
  ...
  var infoOfPokemon = function(Nxtname, allPokemon) {
  ...
  var infoOfPokemon2 = function(nameOfPokemon, allPokemon) {
    for (index in allPokemon) {
        var pEvolutionObject=allPokemon[index].prev_evolution;
      if (pEvolutionObject){
          for(evolutionIndex in pEvolutionObject){
             console.log("Pokemon found :"+ evolutionIndex.name);
          }
  ...
  //infoOfPokemon2(Nxtname,x.pokemon);
