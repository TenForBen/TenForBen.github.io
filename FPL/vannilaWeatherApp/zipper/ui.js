          ...
          this.uiContainer.innerHTML = `
              ...
              <div class="card mx-auto mt-5" style="width: 20rem;">
                  <div class="card-body justify-content-center">
                      ...
                      <p id="xPat">  Lat - <span id="lat">${data.coord.lat}</span>, Lon -<span id="lon"> ${data.coord.lon} </span>  </p>
              ...
              /*
               $("#lon").style.fontWeight="700"
              $("#lat").style.fontWeight="800"
              $("#lat").style.color="blue"
              */
              document.getElementById("lon").style.fontWeight="700"
              document.getElementById("lat").style.fontWeight="800"
